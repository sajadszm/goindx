<?php
/**
 * Popup OTP Login/Register Template
 *
 * @package WPQuickOTP
 * @version 3.0.0
 */
...
?>
<div class="wpqo-template-popup">
    <div class="wpqo-popup-overlay"></div>
    <div class="wpqo-popup-container">
        <a href="#" class="wpqo-close-popup">&times;</a>
                    ...
                    <form id="wpqo-phone-form">
                        ...
                        <div class="wpqo-form-row">
                            <button type="submit" id="wpqo-send-otp-btn">
                                <span class="wpqo-btn-text"><?php _e( 'ارسال کد تایید', 'wp-quickotp' ); ?></span>
                    ...
                    <form id="wpqo-otp-form">
                        ...
                        <div class="wpqo-form-row">
                            <button type="submit" id="wpqo-verify-otp-btn">
                                <span class="wpqo-btn-text"><?php _e( 'تایید و ورود', 'wp-quickotp' ); ?></span>
                                <span class="wpqo-loader"></span>
                            </button>
                        </div>
                    </form>
